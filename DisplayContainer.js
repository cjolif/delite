define(["dcl/dcl", "dojo/_base/lang", "dojo/Deferred", "dojo/when", "delite/Container", "./DisplayController"],
	function (dcl, lang, Deferred, when, Container) {
	return dcl(Container, {
		// summary:
		//		Mixin for widget containers that want to react to delite-display event.
		// description:
		//		By listening to delite-display event a container is able to be notified one of its children must be
