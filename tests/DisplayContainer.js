require.config({
	map: {
		"*": {
			"delite/DisplayController": "delite/tests/DisplayController",
			"delite/DisplayControllerOriginal": "delite/DisplayController"
		}
	}
});
define([
	...
	registerSuite({
		...
		original : function () {
			...
			DisplayController.useOriginal(true).then(function () {
		...
		custom : function () {
			this.timeout = 5000;
			var deferred = new Deferred();
			DisplayController.useOriginal(false).then(function () {
